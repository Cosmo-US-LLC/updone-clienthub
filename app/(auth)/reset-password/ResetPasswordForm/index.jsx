...
const ResetPasswordForm = () => {
  ...
  const {
    ...
    resolver: zodResolver(ResetPasswordFormSchema), // Zod schema resolver
    mode: "onSubmit",
  });
  const {
    register: register2,
  ...
  const handleResend = async () => {
    ...
    try {
      ...
      setError(
        err?.message || "An error occurred while resending the reset link."
      );
      setLoading(false);
    }
  };
  ...
  return (
    <div>
      <div className="max-lg:hidden relative h-full flex items-center justify-center">
        <div className="w-full max-w-md p-8 space-y-6">
          {!messageSent ? (
            ...
            <div className="p-4 rounded-lg flex justify-center items-center flex-col">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="60"
                height="60"
              ...
              <p className="text-sm font-medium text-gray-600 mt-2 pl-4">
                If this email is registered with us, you’ll receive a password
              ...
              <div className="flex justify-start items-center w-full mt-4 text-sm text-gray-600">
                ...
                <button
                  ...
                  className={`text-indigo-600 ml-2 font-medium hover:underline transition-all ${
          ...
          <div className="flex justify-center mt-6">
            <div
              ...
              className="flex items-center gap-1 text-indigo-600 text-[14px] font-medium hover:underline cursor-pointer"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
