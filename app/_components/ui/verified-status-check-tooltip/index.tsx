  ...
  return (
    <div className="flex justify-between items-center flex-col w-[206px]">
      <div className="flex justify-between border-b-[1px] border-[#F6F6F6] px-[10px] py-[8px] items-center w-full">
        <span className="text-[#2C2240] text-[12px] font-[400] leading-[24px] flex justify-start items-center gap-2">
          <span>
            <svg
        ...
        <span
          className={`text-[11px] font-[400] leading-[12px] ${
            contact_is_verified === 1 ? "text-[#0C9000] " : "text-[#C20000]"
          }`}
        >
      ...
      <div className="flex justify-between py-[8px] px-[10px] items-center w-full">
        <span className="text-[#2C2240] text-[12px] font-[400] leading-[24px] flex justify-start items-center gap-2">
          ...
          <span>
            ...
            >
              <path
                d="M13.9998 2.66667H1.99984C1.26346 2.66667 0.666504 3.26362 0.666504 4V12C0.666504 12.7364 1.26346 13.3333 1.99984 13.3333H13.9998C14.7362 13.3333 15.3332 12.7364 15.3332 12V4C15.3332 3.26362 14.7362 2.66667 13.9998 2.66667Z"
                stroke="#2C2240"
                strokeLinecap="round"
                strokeLinejoin="round"
              />
              <path
                d="M0.666504 6.66667H15.3332"
                stroke="#2C2240"
                strokeLinecap="round"
                strokeLinejoin="round"
              />
        ...
        <span
          className={`text-[11px] font-[400] leading-[12px] ${
            id_is_verified === 1 ? "text-[#0C9000] " : "text-[#C20000]"
          }`}
        >
