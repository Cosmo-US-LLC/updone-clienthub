...
//   setSaveMethod,
  ...
  return (
    <>
      <div className="max-w-[1279px] mx-auto relative bottom-[25px] max-lg:pb-0 max-lg:p-4">
        <div
      ...
      <div className="flex max-lg:flex-col gap-[18px] max-lg:px-4 justify-start items-start max-w-[1279px] mx-auto mb-[100px] h-fit">
        <div
          className="max-lg:hidden lg:w-[40%] bg-[#fff] rounded-[12px]"
          style={{ boxShadow: "0px 4px 26px 0px rgba(0, 0, 0, 0.05)" }}
        >
          <div className="py-[32px] px-[16px] text-center w-[99%] mx-auto relative top-[3px] space-y-[12px] bg-[#FAFAFC] rounded-[12px]">
            <h1 className="text-[#000000] tracking-[-0.18px] font-[500] text-[20px]">
              {data?.serviceName}
            </h1>
            <Image
              width={300}
              height={300}
              className="rounded-[50%] m-auto w-[90px] h-[90px]"
              alt=""
              quality={100}
              src={`${data?.worker?.profile_pic}`}
            />{" "}
            <div className="flex justify-center w-full items-center gap-[8px]">
              <h2
                className={`${montserrat.className} leading-[24px] text-[#000000] font-[500] tracking-[-0.14px] !text-[16px]`}
              >
              ...
              <div className="w-full flex justify-between items-center border-b-[1px] pb-[20px] border-[#DEDEDE]">
                ...
                <p className="w-[228px] flex justify-start items-center gap-[8px] tracking-[-0.13px] text-[#6B6B6B] font-[400] text-[13px] leading-normal">
                  <span className="relative top-[1.2px]">
                    {formatJobDetails(data?.job?.working_times[0])}
                  </span>
                </p>
              </div>
          ...
          <div className="relative z-50">
            <div className="pt-[20px] pb-[11px] px-[28px] rounded-[12px] bg-[#F8F7FF] overflow-hidden !z-50 mx-auto w-[99%] relative bottom-[2.5px]">
              ...
              <div className="w-full flex justify-between items-center pt-[16px]">
                <h2
                  className={`tracking-[-0.2px] text-[#000000] font-[500] !text-[20px] leading-normal ${montserrat.className}`}
                >
                  Total
                </h2>
                <p
                  className={`tracking-[-0.36px] !text-[#000000] font-[600] text-[24px] leading-normal flex justify-center items-center ${montserrat.className}`}
                >
              ...
              <div className="w-[99%] m-auto flex justify-center items-center absolute bottom-0 z-[-1] top-1 opacity-[40%]">
                <Image
                  ...
                  height={260}
                  alt=""
                  src="/images/booking/dollar-sign.svg"
                  quality={100}
                />
              </div>
            </div>
        ...
        <div
          className={`${styles.payment_section} max-lg:w-full max-w-[600px] flex flex-col !pb-0 min-h-[41rem] h-full`}
        >
          <StripeCheckoutForm
            offerId={offerId}
            jobId={data?.job?.id}
