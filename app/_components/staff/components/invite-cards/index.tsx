      ...
      {showModal && hideModal ? (
        ...
        <div>
          <div
            ...
            className={`${
              isInvited
                ? "bg-[#FFFBF6] !border-[1px] !border-[#FFE2BE]"
                : "bg-white"
            } py-1 px-2 pb-0 max-w-full mx-auto rounded-[4px] overflow-hidden shadow-whiteeee z-10 border-[1px] border-[#F7F7F7]`}
          >
            <div
              className={`flex flex-row w-full items-center justify-between px-2`}
            >
              <Image
                className={`w-[64px] h-[64px] ${
                  isInvited && "!border-[1px] !border-[#FFE2BE]"
                } rounded-full object-cover !border-[2px] border-[#f3f0ff] bg-[#f3f0ff]`}
                src={
                  staff?.profile_pic
                    ? staff?.profile_pic
              ...
              <div
                className={`w-fit ${
                  isInvited ? "bg-[#FFE2BE]" : "bg-[#e6e0fa]"
                } text-[#350abc] rounded-md gap-2 py-[6px] px-[14px]`}
              >
                <p className="!text-[16px] !font-[400] tracking-[-2%] leading-[28px]">
              ...
              <div className="flex flex-col mt-6 items-center w-full relative z-50">
                <div className="text-center flex justify-between w-full items-center font-bold text-lg mb-[16px]">
                  ...
                  <div className="flex items-center justify-center">
                    ...
                    <p className="ms-1 text-[14px] leading-[24px] font-[400] text-[#000000]">
                ...
                <div className="text-center flex justify-between w-full items-center font-bold text-lg">
                  <div className="text-center text-[14px] font-normal  text-[#989898] flex gap-2">
                    <Image
                      ...
                      height={16}
                    />{" "}
                    <span className="flex justify-start items-center !text-[16px] !font-[400] leading-[28px] !text-[#00000080] cursor-pointer">
                      {staff?.city}
                    </span>
                  </div>
                  <span className="text-[16px] !text-[#6B6B6B] font-[400]">
                ...
                >
                  ...
                  <span className="ml-[8px]">
                    <Image
                      width={16}
                      height={16}
                      src={"/images/client-portal/send.svg"}
                      alt="tick"
                    />
                  </span>
                </button>
