  ...
  return (
    <>
      <div
        ...
        className="min-h-[167vh] 2xl:min-h-[167vh]"
      >
        {/* <div>
          <Header />
        </div> */}
        <div className="absolute z-40 w-full min-h-[100%] flex justify-center items-center bottom-[130px]">
          <div className="md:max-w-[920px] lg:max-w-[1279px] xl:max-w-[1278px] md:px-[3rem] lg:px-[3rem] 2xl:max-w-[1278px] pb-[28px] pt-[28px] px-[16px] top-56 lg:top-40 xl:top-40 2xl:top-16 mx-auto relative contact_us">
            <div
              className={`${montserrat.className} w-[300%] absolute font-[900] top-[-420px] 2xl:top-[-420px] left-[-448px]  flex flex-col text-[#0B0B0B] justify-center items-center uppercase text-center 2xl:text-[110px] xl:text-[110px] lg:text-[100px] leading-[100px]`}
            >
              <h2 className="text-[#f5f5f5] text-[160px] relative z-[-1] top-[115px] w-full">
                CONTACT
              </h2>
              <h2 className="relative bottom-[-50px] font-[600] !text-[60px] normal-case">
                Lets Have A{" "}
                <span className="text-[#350ABC] relative lg:leading-[70px] ">
                  Chat
                </span>
              </h2>
              <div className="pt-[2.5rem]">
                <p className="text-[16px] font-[400] font-poppins leading-[26px] text-center max-w-[714px] w-[100%] mx-auto">
              ...
              <div className="flex pt-[1.5rem] space-x-[60px] justify-between">
                <div className="flex items-center space-x-4">
                  <div className="w-[40px] h-[40px] flex justify-center items-center rounded-full bg-[#F3F0FF]">
                    <Image
                      className=""
                      alt="phone"
                      height={30}
                  ...
                  <div className="space-y-[10px] pl-4 border-l-[3px] border-[#F3F0FF]">
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div className="space-y-[10px] pl-4 border-l-[3px] border-[#F3F0FF]">
                    <p className="text-[16px] font-poppins text-start leading-[100%] font-[600]">
                      MAIL US
                    </p>
                    <div className="flex items-center space-x-2">
                      <p className="text-[11px] font-poppins leading-[100%] text-[#9F9F9F] font-[400]">
