...
const page = () => {
  return (
    <div>
      ...
      <div className="mt-[60px] space-y-[20px] pb-52 md:max-w-[920px] lg:max-w-[1330px] lg:px-[3rem] mx-auto">
        <p className="text-[#6B6B6B] text-[18px] font-[400] leading-[38px]">
          ...
          our services (collectively, the "Services"). By accessing or using our
        ...
        <p className="text-[#6B6B6B] text-[18px] font-[400] leading-[38px]">
          <ol style={{ listStyleType: "decimal", paddingLeft: 20 }}>
            <li>
              ...
              Updone operates an online platform that allows users ("Hosts") to
              connect with service providers ("Talent") who provide event
              staffing services.
            </li>
            <li>
              <span style={{ fontWeight: 600, color: "#000000" }}>
        ...
        <p className="text-[#6B6B6B] text-[18px] font-[400] leading-[38px]">
          <ol style={{ listStyleType: "decimal", paddingLeft: 20 }}>
            <li>
              ...
              services, along with any applicable service fees, upon agreement.
            </li>
            <li>
              <span style={{ fontWeight: 600, color: "#000000" }}>
                Payment Terms:{" "}
            ...
            <li>
              ...
              cancellations before services are rendered or if Updone determines
              the Talent did not meet agreed service levels.
            </li>
          </ol>
        </p>
        <h2
        ...
        <p className="text-[#6B6B6B] text-[18px] font-[400] leading-[38px]">
          <ol style={{ listStyleType: "decimal", paddingLeft: 20 }}>
            <li>
              ...
              Hosts can cancel requests before a Talent has accepted the job. If
              a Host cancels after the Talent accepts, cancellation fees may
              apply.
            </li>
            <li>
              <span style={{ fontWeight: 600, color: "#000000" }}>
            ...
            <li>
              ...
              where disputes cannot be resolved, Updone may intervene and make a
              final decision based on available evidence.
            </li>
          </ol>
        </p>
        <h2
        ...
        <p className="text-[#6B6B6B] text-[18px] font-[400] leading-[38px]">
          <ol style={{ listStyleType: "decimal", paddingLeft: 20 }}>
            ...
            <li>
              ...
              Updone may share user information with other users as necessary to
              facilitate staffing arrangements.
            </li>
          </ol>
        </p>
        <h2
        ...
        <p className="text-[#6B6B6B] text-[18px] font-[400] leading-[38px]">
          <ol style={{ listStyleType: "decimal", paddingLeft: 20 }}>
            ...
            <li>
              ...
              royalty-free license to use, display, and distribute this content
              for the purposes of operating the Services.
            </li>
          </ol>
        </p>
        <h2
        ...
        <p className="text-[#6B6B6B] text-[18px] font-[400] leading-[38px]">
          <ol style={{ listStyleType: "decimal", paddingLeft: 20 }}>
            ...
            <li>
              ...
              Updone’s liability to you for any damages arising from your use of
              the Services is limited to the total fees paid by you to Updone in
              the six months preceding the event giving rise to liability.
            </li>
          </ol>
        </p>
        <h2
        ...
        <p className="text-[#6B6B6B] text-[18px] font-[400] leading-[38px]">
          <ol style={{ listStyleType: "decimal", paddingLeft: 20 }}>
            ...
            <li>
              ...
              fulfilling any outstanding obligations under a Staffing Agreement
