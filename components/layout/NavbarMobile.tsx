...
function NavbarMobile() {
  ...
  return (
    <header className="lg:hidden bg-white min-h-[65px] flex items-center shadow-md">
      <nav className="h-full w-full flex justify-end items-center">
        <div className="flex items-center justify-between z-[100] bg-[#fff] fixed w-full px-[24px] h-[65px]">
              ...
              <div className="grow px-2 flex flex-col justify-between">
                <ul className="list-none space-y-6">
                  ...
                  <li onClick={toggleMenu}>
                    <Link href="/" className={`flex items-center gap-3 ml-2 ${(pathname == "/" || pathname?.includes("/events")) ? "text-[#350abc] font-[500]" : ""}`}>
                  ...
                  <li onClick={toggleMenu}>
                    <Link href="/payments" className={`flex items-center gap-3 ml-2 ${(pathname?.includes("/payments")) ? "text-[#350abc] font-[500]" : ""}`}>
                  ...
                  <li onClick={toggleMenu}>
                    <Link href="/settlements" className={`flex items-center gap-3 ml-2 ${(pathname?.includes("/settlements")) ? "text-[#350abc] font-[500]" : ""}`}>
                  ...
                  <li onClick={toggleMenu}>
                    <Link href="/settings" className={`flex items-center gap-3 ml-2 ${(pathname?.includes("/settings")) ? "text-[#350abc] font-[500]" : ""}`}>
                  ...
                  <li onClick={toggleMenu}>
                    <Link href="/payment-methods" className={`flex items-center gap-3 ml-2 ${(pathname?.includes("/payment-methods")) ? "text-[#350abc] font-[500]" : ""}`}>
