              ...
              <div className="grow px-2 flex flex-col justify-between">
                <ul className="list-none space-y-6">
                  ...
                  <li onClick={toggleMenu}>
                    <Link href="/" className={`flex items-center gap-3 ml-2 ${(pathname == "/" || pathname?.includes("/events")) ? "text-[#774dfd] underline" : ""}`}>
                  ...
                  <li onClick={toggleMenu}>
                    <Link href="/payments" className={`flex items-center gap-3 ml-2 ${(pathname?.includes("/payments")) ? "text-[#774dfd] underline" : ""}`}>
                  ...
                  <li onClick={toggleMenu}>
                    <Link href="/settlements" className={`flex items-center gap-3 ml-2 ${(pathname?.includes("/settlements")) ? "text-[#774dfd] underline" : ""}`}>
                  ...
                  <li onClick={toggleMenu}>
                    <Link href="/settings" className={`flex items-center gap-3 ml-2 ${(pathname?.includes("/settings")) ? "text-[#774dfd] underline" : ""}`}>
                  ...
                  <li onClick={toggleMenu}>
                    <Link href="/payment-methods" className={`flex items-center gap-3 ml-2 ${(pathname?.includes("/payment-methods")) ? "text-[#774dfd] underline" : ""}`}>
